...
/**
 * PRO upgrade promotion, shown ONLY on the Demando settings screen: a dismissible
...
final class ProUpsell
{
    ...
    public function enabled(): bool
    {
        ...
        if (defined('Enquire\\Pro\\VERSION')) {
            return false;
        }
        /**
         * Filters whether the Demando PRO promo is shown on the settings screen.
         *
    ...
    private function url(): string
    {
         ...
         *
         * @param string $url Default the Demando PRO page.
         */
    ...
    private function priceLabel(): string
    {
        ...
        if (! empty($d['price_from'])) {
            ...
            return sprintf(__('from %1$s%2$d/yr', 'demando'), $cur, (int) $d['price_from']);
        }
        return '';
    }
    ...
    public function handleDismiss(): void
    {
        if (! current_user_can('manage_woocommerce')) {
            wp_die(esc_html__('Permission denied.', 'demando'));
        }
    ...
    public function banner(): void
    {
        ...
        $name     = (string) ($this->data()['name'] ?? 'Demando Pro');
        ...
        <div class="enquire-pro-banner" role="note">
            ...
            <p class="enquire-pro-banner__text">
                ...
                printf(esc_html__('Do more with %s', 'demando'), esc_html($name)); ?></strong>
            ...
            <a class="enquire-pro-banner__dismiss" href="<?php echo esc_url($this->dismissUrl()); ?>" aria-label="<?php esc_attr_e('Dismiss this notice', 'demando'); ?>">&times;</a>
        </div>
        <?php
    }
    ...
    public function cards(): void
    {
        ...
        <section class="enquire-pro-cards" aria-labelledby="enquire-pro-cards-h">
            <h2 id="enquire-pro-cards-h" class="enquire-pro-cards__title">
                <?php
                /* translators: %s: PRO edition name */
                printf(esc_html__('What %s adds', 'demando'), esc_html($name)); ?>
            </h2>
